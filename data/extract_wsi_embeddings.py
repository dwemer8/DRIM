...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default="data/models/wsi_encoder.pth", help="Path to the pretrained model weights.")
    parser.add_argument('--mapping_path', type=str, default="data/files/wsi_mapping.json", help="Path to the JSON mapping file for WSI images.")
    ...
    parser.add_argument("--data_path", type=str, default="data/files/wsi_dataset.csv", help="Path to the input dataframe.")
...
def main():
    ...
    for file in os.listdir(output_path):
        file_map[file.split(".")[0]] = os.path.join(output_path, file)
